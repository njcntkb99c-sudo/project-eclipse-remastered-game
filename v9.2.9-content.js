...
$("versionLabel").textContent="Reborn v9.2.9 · Accessibility";
...
let assetsReady=false,victory=false,noticeTimer=0,shake=0,comboCount=0,comboTimer=0,rainTime=0,fogTime=0,hitStop=0,bossAwake=false,reducedMotion=false,highContrast=false;
