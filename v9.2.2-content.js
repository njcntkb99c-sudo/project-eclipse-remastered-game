...
$("versionLabel").textContent="Reborn v9.2.2 · Enemy Variants";
...
function damage(n,x){if(P.inv>0||mode!=="play")return;if(P.block>0&&Math.sign(x-P.x)===P.facing){P.st=Math.max(0,P.st-18);P.inv=.22;burst(P.x+38,P.y+40,"#b8dcff",12);notice("PARATA");return}P.hp-=n;P.inv=1;P.vx=(P.x<x?-1:1)*330;P.vy=-250;shake=9;burst(P.x+30,P.y+45,"#c33b53",18);if(P.hp<=0)die()}
