...
$("versionLabel").textContent="Reborn v9.2.8 · Boss Arena";
...
let assetsReady=false,victory=false,noticeTimer=0,shake=0,comboCount=0,comboTimer=0,rainTime=0,fogTime=0,hitStop=0,bossAwake=false;
...
function reset(){bossAwake=false;enemies.length=0;(MAP.enemySpawns||FALLBACK_MAP.enemySpawns).forEach(x=>enemies.push(enemy(x)));enemies.push(enemy(MAP.bossSpawn||FALLBACK_MAP.bossSpawn,"boss"))}
